...
def test_deteccao_duplicatas():
    ...
    config = {
        ...
        "min_deduplication_confidence": 0.6,  # Mais permissivo para capturar mais duplicatas
        "strict_duplicate_matching": False
    }
    ...
    if resumo['total_produtos_processados'] > 0:
        ...
        print(f"   Eficiência: N/A (produtos processados = 0)")
