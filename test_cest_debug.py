...
def test_debug():
    ...
    # Se funcionou, testar o agente
    if not test_response.get('error'):
        print("\n✅ LLM funcionando! Testando CESTAgent...")
